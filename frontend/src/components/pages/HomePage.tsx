...
const JoyaCard: React.FC<{ o: Opportunity; idx: number }> = ({ o, idx }) => {
  return (
    <div 
      style={{
        backgroundColor: 'var(--color-surface)',
    ...
    >
      ...
      <div style={{ flex: 1, zIndex: 1 }}>
        ...
        <div style={{ fontSize: '0.85rem', fontWeight: 700, color: 'var(--color-secondary)', marginTop: '2px' }}>
          {o.prediction}
        </div>
      </div>
